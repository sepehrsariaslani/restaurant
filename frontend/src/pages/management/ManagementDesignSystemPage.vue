...
import ManagementProductReadinessPanel from '@/components/management/ManagementProductReadinessPanel.vue'
import ManagementProductSummaryCard from '@/components/management/ManagementProductSummaryCard.vue'
