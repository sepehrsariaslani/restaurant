<template>
  <ManagementPageScaffold title="تنظیمات ظاهر" subtitle="رنگ‌بندی پنل مدیریت، وضعیت‌ها و POS را شخصی‌سازی کنید">
    <ManagementSurfaceCard tone="accent">
      <div class="toolbar">
        <button class="primary-btn" type="button" @click="saveSettings">ذخیره تنظیمات</button>
