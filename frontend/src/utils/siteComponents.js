...
export function resolveSiteComponents(boot = {}) {
	...
	const fromSettings =
		boot.web_settings && typeof boot.web_settings === "object" ? boot.web_settings : {};
	...
	return {
		...
		hero_section_variant:
			String(source.hero_section_variant || (heroEnabled ? "fullscreen" : "off")).trim() ||
			"off",
		footer_variant:
			String(source.footer_variant || (footerEnabled ? "full" : "off")).trim() || "full",
