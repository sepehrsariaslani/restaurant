...
def fix_all():
    ...
    # Step 3: Find items with 0 kcal that are in BOMs
    ...
    result_lines = []
    result_lines.append('\nItems with 0 kcal in BOMs:')
    for z in zero_items:
        result_lines.append('  ' + z.name + ' (' + str(z.item_group) + ')')
    ...
    for bp in bom_products:
        ...
        try:
            ...
            result_lines.append('ERR: ' + bp.item + ' -> ' + str(e))
