...
def process_file(filepath):
    ...
    def repl_hex(match):
        ...
        if hex_val in ['#f3f4f6', '#f4f6fa', '#f6f8fb', '#f8fafc', '#f9fafb']: return 'var(--mg-bg-page)'
        
        if hex_val in ['#e5e7eb', '#d6dde8']: return 'var(--mg-border-light)'
        
        if hex_val in ['#16a34a', '#15803d', '#166534', '#0b7d4a', '#22c55e', '#065f46', '#10b981', '#059669']: return 'var(--mg-success)'
        if hex_val in ['#dcfce7', '#d1fae5', '#f0fdf4', '#86efac', '#bbf7d0', '#ecfdf5', '#d1fae5']: return 'var(--mg-success-bg)'
...
process_file('frontend/src/components/management/pos/PosCartPanel.vue')
